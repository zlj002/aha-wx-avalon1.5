!(function() {
    ...
    Array.prototype.indexOf ||
        (Array.prototype.indexOf = function(a, b) {
            ...
            if (((f = +b || 0), 1 / 0 === Math.abs(f) && (f = 0), f >= e))
                return -1;
        ...
        Array.prototype.filter ||
            (Array.prototype.filter = function(a) {
                ...
                for (
                    ...
                    f in b && ((g = b[f]), a.call(e, g, f, b) && d.push(g));
                return d;
            }),
        Array.prototype.map ||
        ...
        'function' != typeof Array.prototype.reduce &&
            (Array.prototype.reduce = function(a, b) {
                ...
                var c,
                    ...
                    f = !1;
                for (
                    1 < arguments.length && ((d = b), (f = !0)), c = 0;
                    e > c;
                    ++c
                )
        ...
        Array.prototype.every ||
            (Array.prototype.every = function(a) {
                ...
                if (
                    ...
                    throw new TypeError();
                for (
                    d = arguments.length >= 2 ? arguments[1] : void 0, e = 0;
                    c > e;
                    e++
                )
            ...
            (Array.prototype.includes = function(a) {
                ...
                for (
                    d = parseInt(arguments[1], 10) || 0,
                        d >= 0 ? (e = d) : ((e = c + d), 0 > e && (e = 0));
                    c > e;

                ) {
                    if (((f = b[e]), a === f || (a !== a && f !== f)))
                        return !0;
                    e++;
                }
                return !1;
...
var Util = {
    ...
    isWeChat: function() {
        if (
            window.navigator.userAgent.toLowerCase().match('micromessenger') ||
            !!window.navigator.userAgent.match('MicroMessenger')
        ) {
            return true;
        }
        return false;
    ...
    isInApp: function() {
        ...
        return (
            !!ua.match(/Ahaschool\/Android/i) || !!ua.match(/Ahaschool\/ios/i)
        );
    },
    getAbsUrl: function(url) {
        ...
        var _result = /^(?:https?|ftp):\/\//i.test(a.href)
            ? a.href
            : a.getAttribute('href', 4);
    ...
    delURIParam: function(url, paramKey) {
        ...
        var urlParam =
            url.indexOf('?') <= -1 ? '' : url.substr(url.indexOf('?') + 1);
        var beforeUrl =
    ...
    setCookie: function(name, value, expiredays, domain, path) {
        var Days =
                parseInt(expiredays) && parseInt(expiredays) > 0
                    ? parseInt(expiredays)
                    : 30,
            exp = new Date();
    ...
    lStorage: {
        setItem: function(_key, _val) {
            'object' == typeof localStorage
                ...
                : Util.setCookie(_key, _val, 366, '', '/');
        },
        getItem: function(_key) {
            return 'object' == typeof localStorage
    ...
    sStorage: {
        setItem: function(_key, _val) {
            'object' == typeof sessionStorage
                ? sessionStorage.setItem(_key, _val)
                : Util.setCookie(_key, _val, 0, '', '/');
        },
        getItem: function(_key) {
            return 'object' == typeof sessionStorage
    ...
    callAppMethod: function(methodStr) {
        ...
        if (arguments.length > 1)
            _param = Array.prototype.slice.call(arguments, 1);
        if (
            window['AHASCHOOL'] &&
            typeof window['AHASCHOOL'][methodStr] == 'function'
        ) {
            return window['AHASCHOOL'][methodStr].apply(
                window['AHASCHOOL'],
                _param
            );
        }
