var Draw = {
    ...
    drawRing: function (opts) {
        ...
        var parent = _opts.parent,
            ...
            after = _opts.after,
            needBG = _opts.needBG,
            needCenterText = _opts.needCenterText;
        ...
        function fillArc(x) {
            ...
            ctx.arc(width / 2, width / 2, radius, 0 * Math.PI / 180, (x * 3.6 - 360) * Math.PI / 180);
            ctx.arc(radius, radius, radius, 0 * Math.PI / 180, (x * 3.6 - 360) * Math.PI / 180);
            ctx.stroke();
        }
